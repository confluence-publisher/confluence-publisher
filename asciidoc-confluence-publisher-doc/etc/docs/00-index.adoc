    ...
    <plugin>
      ...
      <configuration>
        ...
        <attributes>
            ...
            <someOtheKey>value</someOtherKey>
        </attributes>
      </configuration>
    </plugin>
  </plugins>
...
| attributes| Attributes used during AsciiDoctor processing.
See more details about attributes: https://asciidoctor.org/docs/user-manual/#attributes

NOTE: when using Docker-based publishing, user attributes have to be provided as JSON object structure.

NOTE: user attributes are currently not supported for using in the page title.
