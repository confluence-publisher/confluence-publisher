  ...
  <plugins>
    <plugin>
      ...
      <configuration>
        ...
        <minorEdit>false</minorEdit> <!-- notify page subscribers -->
        <attributes>
...
| minorEdits
| Defines whether to not notify page/space subscribers upon export.

If `true`, subscribers will not receive notifications, except for new page creations.
| optional (defaults to false)
|===
