...
<<index/sub-page.adoc#,Cross Reference>>

== Attachment in Sub-Folder

link:index/attachmentOne.txt[Attachment One]

== Includes

include::index/_included-page.adoc[]
