...
| proxyScheme
| The scheme (http, https) of the proxy (in case a forward proxy needs to be used for accessing the Confluence instance).
| optional (defaults to empty)
...
| proxyUsername
| The username of the proxy (in case the proxy requires basic authentication).
| optional (defaults to empty)

| proxyPassword
| The password of the proxy (in case the proxy requires basic authentication).
| optional (defaults to empty)
|===
