...
| CONFLUENCE_IT_API_TOKEN    | normal api token of atlassian user for publishing to integration test space | (secret)                                        |
| CONFLUENCE_IT_SCOPED_TOKEN | scoped api token of atlassian user for publishing to integration test space | (secret)                                        |
