...
[NOTE]
====
Table width values are not honoured explicitly by the new Confluence editor.
Table width values are mapped to the default, wide or full-width table layout based on internal Confluence editor logic.
====
