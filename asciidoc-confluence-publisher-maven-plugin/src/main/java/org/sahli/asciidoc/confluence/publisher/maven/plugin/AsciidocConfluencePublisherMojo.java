...
import org.sahli.asciidoc.confluence.publisher.converter.HeadingBasedAsciidocPagesStructureProvider;
...
public class AsciidocConfluencePublisherMojo extends AbstractMojo {
    ...
    public void execute() throws MojoExecutionException {
        try {
            ...
            // TODO add support for configuring structure provider to be used
//            AsciidocPagesStructureProvider asciidocPagesStructureProvider = new FolderBasedAsciidocPagesStructureProvider(this.asciidocRootFolder.toPath(), Charset.forName(this.sourceEncoding));
            ...
            // TODO add support for configuring root file (or scan all adoc files in root folder)
            AsciidocPagesStructureProvider asciidocPagesStructureProvider = new HeadingBasedAsciidocPagesStructureProvider(this.asciidocRootFolder.toPath().resolve("single.adoc"), Charset.forName(this.sourceEncoding), this.confluencePublisherBuildFolder.toPath());
