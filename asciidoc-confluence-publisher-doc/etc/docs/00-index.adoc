...
In case you want to extend the Docker image or your build runs inside this image you should
use the script `/publish.sh` for invoking the actual publishing. E.g. using this image as
GitLab CI job could look like:
